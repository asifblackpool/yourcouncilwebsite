 $('document').ready(function() {
        ...
        hexCodes.push({ key: 'the', party: 'The Conservative Party Candidate', hexcolor: '#0087DC' });
        hexCodes.push({ key:'lab',  party: 'Labour party', hexcolor: ' #DC241f' });
        ...
        hexCodes.push({ key: 'brx', party: 'Brexit', hexcolor: '#12B6CF' });
        hexCodes.push({ key: 'blk', party: 'Blank', hexcolor: '#ccd2d5' });

        electionservices.init(window.chartservices, hexCodes, "1Ltp8P5ZUt9Xex0_10Jp95NLlcRlKIrHM6Mn0ICrJE_0", false);
